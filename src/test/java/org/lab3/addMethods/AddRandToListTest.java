...
class AddRandToListTest {
    int numOperations = 10000;
    int numTests = 50;
    double accept_rate = 0.5;
    @Test
    void addRandToArrayList() {
        ...
        for (int i = 0; i<numTests; ++i)
        {
            ...
            CollectionMethodPerformanceMeasure<String> testAdd =
                    new CollectionMethodPerformanceMeasure<>(numOperations, new AddRandToList<>(arrayList, () -> "hello"));
            ...
            for (int j = 0; j<numOperations;j++){
                int ind =(int)(Math.random()*arrayList.size());
    ...
    void addRandToLinkedList() {
        ...
        for (int i = 0; i<numTests; ++i)
        {
            ...
            CollectionMethodPerformanceMeasure<String> testAdd =
                    new CollectionMethodPerformanceMeasure<>(numOperations, new AddRandToList<>(linkedList, () -> "hello"));
            ...
            long time = 0;
            for (int j = 0; j<numOperations;j++){
                int ind =(int)(Math.random()*linkedList.size());
                long start = System.nanoTime();
